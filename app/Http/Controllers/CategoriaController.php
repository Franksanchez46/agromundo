...
use Illuminate\Support\Facades\DB; // Habilita el registro de consultas para depuración
class CategoriaController extends Controller
{
    ...
    {
        // Habilita el registro de consultas para depuración
        DB::enableQueryLog();

        // Filtra las categorías por nombre si se proporciona un parámetro de búsqueda
